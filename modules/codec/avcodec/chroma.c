...
static const struct vlc_chroma_ffmpeg chroma_table[] =
{
    ...
    {VLC_CODEC_DRM_PRIME_I420, AV_PIX_FMT_DRM_PRIME, COLOR_RANGE_UNDEF },
    {VLC_CODEC_DRM_PRIME_NV12, AV_PIX_FMT_DRM_PRIME, COLOR_RANGE_UNDEF },
    {VLC_CODEC_DRM_PRIME_SAND8, AV_PIX_FMT_DRM_PRIME, COLOR_RANGE_UNDEF },
    {VLC_CODEC_DRM_PRIME_SAND30, AV_PIX_FMT_DRM_PRIME, COLOR_RANGE_UNDEF },
};
